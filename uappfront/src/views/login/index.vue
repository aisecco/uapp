<template>
  <div class="login-container">
      ...
      <el-tooltip v-model="capsTooltip" content="Caps lock is On" placement="right" manual>
        <el-form-item prop="password">
          ...
          <el-input :key="passwordType" ref="password" v-model="loginForm.password" :type="passwordType" placeholder="密码"
            name="password" tabindex="2" auto-complete="on" @keyup.native="checkCapslock" @blur="capsTooltip = false"
    ...
    <div class="account-foot-copyright">
      <span>Copyright ©2022-2023 UAPP 版权所有</span>
    </div>
  </div>
</template>
